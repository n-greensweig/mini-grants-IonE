        ...
        <div id="review-form">
            ...
            <form>
                <table>
                    ...
                    <tr id="first">
                        <td className="radio-td"><input type="radio" id="5" name="interdisciplinary" value={interdisciplinary} onChange={interdisciplinaryRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second">
                        <td className="radio-td"><input type="radio" id="3" name="interdisciplinary" value={interdisciplinary} onChange={interdisciplinaryRadioChange}/></td>
                        <td>
                    ...
                    <tr id="third">
                        <td className="radio-td"><input type="radio" id="2" name="interdisciplinary" value={interdisciplinary} onChange={interdisciplinaryRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second-to-last">
                        <td className="radio-td"><input type="radio" id="1" name="interdisciplinary" value={interdisciplinary} onChange={interdisciplinaryRadioChange}/></td>
                        <td>
                    ...
                    <tr id="last">
                        <td className="radio-td"><input type="radio" id="0" name="interdisciplinary" value={interdisciplinary} onChange={interdisciplinaryRadioChange}/></td>
                        <td>
            ...
            <form>
                <table>
                    ...
                    <tr id="first">
                        <td className="radio-td"><input type="radio" id="5" name="goals" value={goals} onChange={goalsRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second">
                        <td className="radio-td"><input type="radio" id="3" name="goals" value={goals} onChange={goalsRadioChange}/></td>
                        <td>
                    ...
                    <tr id="third">
                        <td className="radio-td"><input type="radio" id="2" name="goals" value={goals} onChange={goalsRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second-to-last">
                        <td className="radio-td"><input type="radio" id="1" name="goals" value={goals} onChange={goalsRadioChange}/></td>
                        <td>
                    ...
                    <tr id="last">
                        <td className="radio-td"><input type="radio" id="0" name="goals" value={goals} onChange={goalsRadioChange}/></td>
                        <td>
            ...
            <form>
                <table>
                    ...
                    <tr id="first">
                        <td className="radio-td"><input type="radio" id="5" name="method_and_design" value="method_and_design" onChange={method_and_designRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second">
                        <td className="radio-td"><input type="radio" id="3" name="method_and_design" value="method_and_design" onChange={method_and_designRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second-to-last">
                        <td className="radio-td"><input type="radio" id="2" name="method_and_design" value="method_and_design" onChange={method_and_designRadioChange}/></td>
                        <td>
                    ...
                    <tr id="last">
                        <td className="radio-td"><input type="radio" id="0" name="method_and_design" value="method_and_design" onChange={method_and_designRadioChange}/></td>
                        <td>
            ...
            <form>
                <table>
                    ...
                    <tr id="first">
                        <td className="radio-td"><input type="radio" id="2" name="budget" value="budget" onChange={budgetRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second">
                        <td className="radio-td"><input type="radio" id="1" name="budget" value="budget" onChange={budgetRadioChange}/></td>
                        <td>
                    ...
                    <tr id="second-to-last">
                        <td className="radio-td"><input type="radio" id="0.5" name="budget" value="budget" onChange={budgetRadioChange}/></td>
                        <td>
                            <span id="points">0.5 pts</span>- Budget lacks sufficient detail.
                        </td>
                    </tr>
                    <tr id="last">
                        <td className="radio-td"><input type="radio" id="0" name="budget" value="budget" onChange={budgetRadioChange}/></td>
                        <td>
            ...
            <form>
                <table>
                    ...
                    <tr id="white">
                        <td className="radio-td"><input type="checkbox" id="2" name="impact1" value="impact1" onChange={(e) => setImpact1(e.target.checked ? e.target.id : 0)}/></td>
                        <td>
                            <span id="points">2 pts</span> - Meaningfully addresses diversity, equity, inclusion and/or justice.
                        </td>
                    </tr>
                    <tr id="white">
                        <td className="radio-td"><input type="checkbox" id="2" name="impact2" value="impact2" onChange={(e) => setImpact2(e.target.checked ? e.target.id : 0)}/></td>
                        <td>
                    ...
                    <tr id="white">
                        <td className="radio-td"><input type="checkbox" id="2" name="impact3" value="impact3" onChange={(e) => setImpact3(e.target.checked ? e.target.id : 0)}/></td>
                        <td>
            ...
            <form>
                <table>
                    ...
                    <tr id="first">
                        <td className="radio-td"><input type="radio" id="3" name="recommendation" value={recommendation} onChange={recommendationRadioChange}/></td>
                        <td><span id="points">3 pts</span><span id="points"></span> - Proposal recommended for full funding.</td>
                    </tr>
                    <tr id="second">
                        <td className="radio-td"><input type="radio" id="2" name="recommendation" value={recommendation} onChange={recommendationRadioChange}/></td>
                        <td><span id="points">2 pts</span> - Proposal should be funded in accordance with available resources.</td>
                    </tr>
                    <tr id="last">
                        <td className="radio-td"><input type="radio" id="0" name="recommendation" value={recommendation} onChange={recommendationRadioChange}/></td>
                        <td> 
